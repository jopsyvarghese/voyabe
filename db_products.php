...
function selectimage(){ //index.php
...
function selectimage1($id){ //index.php
...
function selectDetailsById($id){ //product-view.php
...
function selectBySearchedItem($item) { //in search-product-check.php
...
function selectByShop($id){ //shop-details.php
...
//echo $sql;
  ...
  return $result; 
    ...
    function selectByProductId($id) { // used in productdetails.php,products.php
        $sql = "SELECT * FROM  products WHERE product_id='$id'";
        $result = $this->database->query($sql);
        $result = $this->database->result;
        $row = mysqli_fetch_object($result);
...
function selectByCategory($sub_category_id,$min,$max) {  //category-ite.php
...
function selectdiscount($id){
 ...
 function selectByCategor($category_id,$pid) {  //index.php
 ...
 function selectAllProducts2() {  //menu1.php
   ...
   function selectdistinctProducts(){
        ...
        $sql = "SELECT  DISTINCT product_id,product_name,price,discount,main_image,shop_id  FROM products Group BY shop_id DESC LIMIT 0,10";
        $result = $this->database->query($sql);
        $result = $this->database->result;
        return $result;
     ...
     function selectdistinctProducts1(){
        ...
        $sql = "SELECT  * FROM products  WHERE maincategory_id = 4 LIMIT 0,10";
        $result = $this->database->query($sql);
        $result = $this->database->result;
        return $result;
     ...
     function selectdistinctProducts2(){
        ...
        $sql = "SELECT  * FROM products  WHERE maincategory_id=25 LIMIT 0,10";
        $result = $this->database->query($sql);
        $result = $this->database->result;
        return $result;
     ...
     function selectdistinctProducts3(){
        ...
        $sql = "SELECT  * FROM products  WHERE category_id=29 LIMIT 0,10";
        $result = $this->database->query($sql);
        $result = $this->database->result;
        return $result;
     ...
     function selectdistinctProducts4(){
       ...
       function selectdistinctProducts5(){
        ...
        $sql = "SELECT  * FROM products  WHERE category_id=116 LIMIT 0,10";
        $result = $this->database->query($sql);
        $result = $this->database->result;
        return $result;
   ...
   function selectAllProducts1() {  //menu1.php
    ...
    function selectProductsByCatPagination($id,$pageno,$limit) {
        $sql = "SELECT * FROM products WHERE category_id=$id ORDER BY product_id DESC LIMIT $pageno,$limit";
        $result = $this->database->query($sql);
        $result = $this->database->result;
        if (!$result) {
...
FROM  products  JOIN sub_category ON products.sub_category_id = sub_category.sub_category_id
 JOIN main_category ON products.maincategory_id = main_category.maincategory_id JOIN category ON category.category_id = products.category_id WHERE products.product_id='$id'";
    ...
    function selectbyshopid($id) {//sellerproducts.php
        $sql = "SELECT * FROM products WHERE shop_id ='$id'";
        //echo $sql;
    ...
    function selectAllByShopId($id) { //used in productdetails.php,product-details.php
    ...
    function joinbyproductid($id) {//sellerproducts.php
...
//////echo "<br>category name".$row->category_name;
    ...
    function selectAllByProductId($id) { //used in reviews.php
