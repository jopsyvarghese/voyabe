						...
						<div class="new-collections-grid1 products-right-grid1 animated wow slideInUp" data-wow-delay=".5s" style="height:400px;">
							<div class="new-collections-grid1-image">
								...
								<?php if($row['main_image']!=""){ ?>
								   ...
								   <a href="product-details.php?p_id=<?php  echo $row['product_id']; ?>" class="product-image"><img style="height:160px;" src="<?php echo 'upload/itemimage/'.$row['main_image'];?>" alt="image" class="img-responsive"></a>
                                <?php }else { ?>
								<a href="product-details.php?p_id=<?php  echo $row['product_id']; ?>" class="product-image"><img style="height:160px;" src="images/camera.png" alt="image" class="img-responsive"></a>
								<?php } ?>
								</div>
